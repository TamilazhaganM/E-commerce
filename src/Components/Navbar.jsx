      ...
      {menuOpen && (
        <div className="lg:hidden mt-4 bg-white shadow-lg  w-full p-4 rounded-xl"> 
          <ul className="flex flex-col gap-4 text-amber-950 font-italic text-sm z-100">
            ...
            </li>            <li onClick={() => setMenuOpen(!menuOpen)}><Link to="/home/womens">WOMENS</Link></li>
            <li onClick={() => setMenuOpen(!menuOpen)}><Link to="/home/kids">KIDS</Link></li>
            <li onClick={() => setMenuOpen(!menuOpen)}><Link to="/home/accessories">ACCESSORIES</Link></li>
            <li onClick={() => setMenuOpen(!menuOpen)}><Link to="/home/partywears">PARTY WEAR</Link></li>
