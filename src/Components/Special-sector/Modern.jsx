...
import modern1 from '../../assets/image/Modern/modern1.jpg'
import modern2 from '../../assets/image/Modern/modern2.jpg'
import modern3 from '../../assets/image/Modern/modern3.jpg'
import modern4 from '../../assets/image/Modern/modern4.jpg'
import modern5 from '../../assets/image/Modern/modern5.jpg'
import modern6 from '../../assets/image/Modern/modern6.jpg'
...
function Modern() {
  ...
  const Images = [
        { id: 1, visibleImage: modern1,rate:1000},
        { id: 2, visibleImage: modern2,rate:2000},
        { id: 3, visibleImage: modern3,rate:3000},
        { id: 4, visibleImage: modern4,rate:1200},
        { id: 5, visibleImage: modern5,rate:4000},
        { id: 6, visibleImage: modern6,rate:3000},
      ];
      return (
        <div className="p-10">
          <div className="text-xs my-20 bg-white shadow-sm">
            <h2>MENS | CLOTHING-MODERN</h2>
            ...
            {Images.map((image, index) => {
              return (
                ...
                >
                  ...
                  <button cclassName="group  rounded-full transition-colors 
                  "
                  ...
                  <p className="absolute text-xs italic  bottom-4 w-18 left-1/2 -translate-x-5 -my-3 mx-auto  justify-center ">RS.  {image.rate ?? "N/A"} {/* If rate is undefined, show "N/A" */}</p>
