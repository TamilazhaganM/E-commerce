...
import men1 from '../../assets/image/Accessories/mens1.jpg'
import men2 from '../../assets/image/Accessories/men2.jpg'
import men3 from '../../assets/image/Accessories/mens3.jpg'
import women1 from '../../assets/image/Accessories/women1.jpg'
...
function Accessories() {
 ...
 const Images = [
     { id: 1, visibleImage: men1,rate: 250 },
     { id: 2, visibleImage: men2,rate: 1200  },
     { id: 3, visibleImage: men3,rate: 1400  },
     { id: 4, visibleImage: women1 ,rate: 2500 },
     { id: 5, visibleImage: women2,rate: 2000  },
     { id: 6, visibleImage: women3,rate: 2500  },
   ];
   return (
     <div className="p-5">
     <div className="lg:text-xs font-semibold lg:my-20 bg-white shadow-sm">
         <h2>MEN & WOMEN | CLOTHING-ACCESSORIES</h2>
