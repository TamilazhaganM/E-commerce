    ...
    <div>
      ...
      <div className="lg:hidden flex items-center justify-between">
        ...
        <div className="flex ">
          ...
          <button className="flex items-center justify-center  px-4 py-2 rounded hover:bg-gray-200 w-30  ">
            ...
            {favourite > 0 && (
              <span className="absolute top-1 right-16 bg-red-500 text-white text-xs px-1.5 rounded-full">
                {favourite}
              </span>
            )}
          </button>
          <button
            className="flex  justify-center bg-white-500 text-white px-4 py-2 rounded hover:bg-gray-200 w-30"
          ...
          <ul className="flex flex-col gap-4 text-amber-950 font-italic text-sm z-100">
            ...
            <li className=" text-amber-950 font-italic group relative text-xs">
              ...
              <div className="hidden group-hover:block absolute left-0 bg-white shadow-lg p-2">
                <ul className="">
                  <li className="hover:text-amber-400 cursor-pointer p-2 w-full">
                    <Link to={"/home/kids"} onClick={() => setMenuOpen(!menuOpen)} className=" hover:text-amber-400 ">
                      PRINCE
                    </Link>
                  </li>{" "}
                  <hr></hr>
            ...
            <li onClick={() => setMenuOpen(!menuOpen)}>
              <Link to="/home/accessories">ACCESSORIES</Link>
            </li>
            <li onClick={() => setMenuOpen(!menuOpen)}>
              <Link to="/home/partywears">PARTY WEAR</Link>
            </li>
            <li>
              <button
                onClick={handlePayment}
                className="w-2/4 bg-amber-950 text-white p-2 rounded"
              >
                Go to Payment
              </button>
            </li>
      ...
      <nav className="hidden lg:flex fixed top-0 left-0 w-full bg-white z-50 pt-10">
        <div className=" container flex mx-auto items-center justify-between p-2 ">
          ...
          <div className="flex  rounded-lg  ml-5   w-40">
