...
import women1 from '../../assets/image/women-section/saree1.jpg'
import women2 from '../../assets/image/women-section/saree2.jpg'
import women3 from '../../assets/image/women-section/saree3.jpg'
import women4 from '../../assets/image/women-section/saree4.jpg'
...
function Womens() {
  ...
  const Images = [
      { id: 1, visibleImage: women1,rate:1000 },
      { id: 2, visibleImage: women2,rate:1500 },
      { id: 3, visibleImage: women3,rate:1200 },
      { id: 4, visibleImage: women4,rate:1400 },
      { id: 5, visibleImage: women5,rate:1500 },
      { id: 6, visibleImage: women6,rate:2000 },
    ];
    return (
      <div className="p-10">
        <div className="text-xs my-20 bg-white shadow-sm">
          <h2>MENS | CLOTHING-SAREES</h2>
