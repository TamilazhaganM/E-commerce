...
import party1 from '../../assets/image/partysection/party1.jpg'
import party5 from '../../assets/image/partysection/party5.jpg'
import party2 from '../../assets/image/partysection/party2.jpg'
import party6 from '../../assets/image/partysection/party6.jpg'
...
function Partywear() {
  ...
  const Images = [
        { id: 1, visibleImage: party1,rate:2200},
        { id: 2, visibleImage: party5,rate:4000},
        { id: 3, visibleImage: party3,rate:2500},
        { id: 4, visibleImage: party6,rate:3000},
        { id: 5, visibleImage: party2,rate:2000},
        { id: 6, visibleImage: party4,rate:1200},
      ];
      return (
        <div className="p-5">
     <div className="lg:text-xs font-semibold lg:my-20 bg-white shadow-sm">
            <h2>MEN & WOMEN | CLOTHING-PARTY-WEAR</h2>
